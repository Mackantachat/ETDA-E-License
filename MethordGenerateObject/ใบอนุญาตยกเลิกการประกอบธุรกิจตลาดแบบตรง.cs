...
{
    class OCPBDirectMarketingCancelAppHook : SingleFormRendererAppHook
    {
        ...
        public override JObject GenerateELicenseData(Guid applicationrequestId)
        {
            ...
            var relateLicenseNo = request.Data.TryGetData("").ThenGetStringData(""); //เลขที่ใบอนุญาตเก่าที่ใช้อ้างอิง
