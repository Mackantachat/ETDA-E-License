...
{
    class OCPBDirectMarketingEditAppHook : SingleFormRendererAppHook
    {
        ...
        public override string PrintFormTitle
        {
            get
            {
                return "คำขอจดทะเบียนประกอบธุรกิจตลาดแบบตรง";
            }
        }
        ...
        public override JObject GenerateELicenseData(Guid applicationrequestId)
        {
            ...
            var specifiedPersonName = request.IdentityName;
            ...
            var signer = request.Data.TryGetData("ELICENSE_INFORMATION").ThenGetStringData("Signer_0").ToThaiDigit(); // ผู้อนุมัติ
            var signerDescription = request.Data.TryGetData("ELICENSE_INFORMATION").ThenGetStringData("SignerDecription_0").ToThaiDigit(); // รายละเอียดผู้อนุมัติ
            ...
            var relateLicenseNo = request.Data.TryGetData("").ThenGetStringData(""); //เลขที่ใบอนุญาตเก่าใช้สำหรับอ้างอิง
            ...
            if (requestLicenseOriginal.Data.TryGetData("APP_DIRECT_MARKETING_SECTION").ThenGetBooleanData("DIRECT_MARKETING_SELECT_PRODUCT_DIRECT_SELL_PRODUCT_FOOD"))
            {
                productListName.Add("อาหาร");
                countProduct += 1;
            }
            if (requestLicenseOriginal.Data.TryGetData("APP_DIRECT_MARKETING_SECTION").ThenGetBooleanData("DIRECT_MARKETING_SELECT_PRODUCT_DIRECT_SELL_PRODUCT_COSMETIC"))
            {
                productListName.Add("เครื่องสำอาง");
                countProduct += 1;
            }
            if (requestLicenseOriginal.Data.TryGetData("APP_DIRECT_MARKETING_SECTION").ThenGetBooleanData("DIRECT_MARKETING_SELECT_PRODUCT_DIRECT_SELL_PRODUCT_JEWELRY"))
            {
                productListName.Add("เครื่องประดับ");
                countProduct += 1;
            }
            if (requestLicenseOriginal.Data.TryGetData("APP_DIRECT_MARKETING_SECTION").ThenGetBooleanData("DIRECT_MARKETING_SELECT_PRODUCT_DIRECT_SELL_PRODUCT_KITCHENWARE"))
            {
                productListName.Add("เครื่องครัว");
                countProduct += 1;
            }
            if (requestLicenseOriginal.Data.TryGetData("APP_DIRECT_MARKETING_SECTION").ThenGetBooleanData("DIRECT_MARKETING_SELECT_PRODUCT_DIRECT_SELL_PRODUCT_EDUCATION"))
            {
                productListName.Add("สื่อการศึกษา");
                countProduct += 1;
            }
            if (requestLicenseOriginal.Data.TryGetData("APP_DIRECT_MARKETING_SECTION").ThenGetBooleanData("DIRECT_MARKETING_SELECT_PRODUCT_DIRECT_SELL_PRODUCT_AGRICULTURE"))
            {
                productListName.Add("สินค้าเกษตรกรรม");
                countProduct += 1;
            }
            if (requestLicenseOriginal.Data.TryGetData("APP_DIRECT_MARKETING_SECTION").ThenGetBooleanData("DIRECT_MARKETING_SELECT_PRODUCT_DIRECT_SELL_PRODUCT_FITNESS"))
            {
                productListName.Add("อุปกรณ์ออกกำลังกาย");
                countProduct += 1;
            }
            if (requestLicenseOriginal.Data.TryGetData("APP_DIRECT_MARKETING_SECTION").ThenGetBooleanData("DIRECT_MARKETING_SELECT_PRODUCT_DIRECT_SELL_PRODUCT_TOOLS"))
            {
                productListName.Add("เครื่องใช้ไฟฟ้า");
                countProduct += 1;
            }
            if (requestLicenseOriginal.Data.TryGetData("APP_DIRECT_MARKETING_SECTION").ThenGetBooleanData("DIRECT_MARKETING_SELECT_PRODUCT_DIRECT_SELL_PRODUCT_CLOTH"))
            {
                productListName.Add("เสื้อผ้า/เครื่องนุ่งห่ม");
                countProduct += 1;
            }
            if (requestLicenseOriginal.Data.TryGetData("APP_DIRECT_MARKETING_SECTION").ThenGetBooleanData("DIRECT_MARKETING_SELECT_PRODUCT_DIRECT_SELL_PRODUCT_BOOK"))
            {
                productListName.Add("หนังสือ/สิ่งพิมพ์");
                countProduct += 1;
            }
            if (requestLicenseOriginal.Data.TryGetData("APP_DIRECT_MARKETING_SECTION").ThenGetBooleanData("DIRECT_MARKETING_SELECT_PRODUCT_DIRECT_SELL_PRODUCT_SEMINAR"))
            {
                productListName.Add("การอบรม/สัมมนา");
                countProduct += 1;
            }
            if (requestLicenseOriginal.Data.TryGetData("APP_DIRECT_MARKETING_SECTION").ThenGetBooleanData("DIRECT_MARKETING_SELECT_PRODUCT_DIRECT_SELL_PRODUCT_SERVICE"))
            {
                productListName.Add("การบริการ");
                countProduct += 1;
            }
            if (requestLicenseOriginal.Data.TryGetData("APP_DIRECT_MARKETING_SECTION").ThenGetBooleanData("DIRECT_MARKETING_SELECT_PRODUCT_DIRECT_SELL_PRODUCT_OTHER"))
            {
                var productListOther = requestLicenseOriginal.Data.TryGetData("APP_DIRECT_MARKETING_SECTION").ThenGetStringData("DIRECT_SELL_PRODUCT_OTHER_DETAIL");
                productListName.Add(productListOther);
                countProduct += 1;
            }
            productList = String.Join(",", productListName);

            var directMarkettingDistributionChannel = string.Empty;
            var directMarketingDistributionChannelText = new List<string>();

            if (requestLicenseOriginal.Data.TryGetData("APP_DIRECT_MARKETING_SECTION").ThenGetBooleanData("DIRECT_MARKETING_SELECT_CHANNEL_DIRECT_MARKETING_SELECT_CHANNEL_PRINT"))
            {
                directMarketingDistributionChannelText.Add("ขายผ่านสื่อสิ่งพิมพ์");
            }
            if (requestLicenseOriginal.Data.TryGetData("APP_DIRECT_MARKETING_SECTION").ThenGetBooleanData("DIRECT_MARKETING_SELECT_CHANNEL_DIRECT_MARKETING_SELECT_CHANNEL_RADIO"))
            {
                directMarketingDistributionChannelText.Add("ขายผ่านสื่อวิทยุกระจายเสียง");
            }
            if (requestLicenseOriginal.Data.TryGetData("APP_DIRECT_MARKETING_SECTION").ThenGetBooleanData("DIRECT_MARKETING_SELECT_CHANNEL_DIRECT_MARKETING_SELECT_CHANNEL_TV"))
            {
                directMarketingDistributionChannelText.Add("ขายผ่านสื่อวิทยุโทรทัศน์");
            }
            if (requestLicenseOriginal.Data.TryGetData("APP_DIRECT_MARKETING_SECTION").ThenGetBooleanData("DIRECT_MARKETING_SELECT_CHANNEL_DIRECT_MARKETING_SELECT_CHANNEL_MEDIA"))
            {
                directMarketingDistributionChannelText.Add("ขายผ่านสื่ออิเล็กทรอนิกส์");
            }
            if (requestLicenseOriginal.Data.TryGetData("APP_DIRECT_MARKETING_SECTION").ThenGetBooleanData("DIRECT_MARKETING_SELECT_CHANNEL_DIRECT_MARKETING_SELECT_CHANNEL_OTHER"))
            {
                var sellChannelOther = requestLicenseOriginal.Data.TryGetData("APP_DIRECT_MARKETING_SECTION").ThenGetStringData("DIRECT_MARKETING_SELECT_CHANNEL_DIRECT_MARKETING_SELECT_CHANNEL_OTHER");
                directMarketingDistributionChannelText.Add(sellChannelOther);
            }
            directMarkettingDistributionChannel = String.Join(",", directMarketingDistributionChannelText);

            var informationBusinessDirectMarketing = productList + countProduct.ToString() + directMarkettingDistributionChannel;
            ...
            var data = new
            {
                ...
                {
                    ram__Name = "ใบอนุญาตประกอบธุรกิจตลาดแบบตรง",
                    ...
                    rsm__TradLineItem = new
                    {
                        ram__SpecifiedTradeProduct = new
                        {
                            ...
                            {
                                ram__Content = informationBusinessDirectMarketing
                            }
                        }
                    }
                }
