...
namespace BizPortal.AppsHook
{
    public class HSSClinicBusinessEditAppHook : StoreBaseAppHook
    {
        ...
        public override JObject GenerateELicenseData(Guid applicationrequestId)
        {
            ...
            var relateLicenseNumber = request.Data.TryGetData("APP_CLINIC_EDIT_INFO_SECTION_2").ThenGetStringData("APP_CLINIC_EDIT_INFO_SECTION_2_REQUEST_ID"); // เลขที่ใบอนุญาตเดิมที่อ้างอิงถึง
            ...
            if (request.Data.TryGetData("APP_CLINIC_EDIT_INFO_SECTION_2").ThenGetBooleanData("APP_CLINIC_EDIT_INFO_SECTION_2_REQUEST_CHANGE_REQUEST_CHANGE_WORKING_DATE") == true)
            {
                if (int.TryParse(editWorkingDay["APP_CLINIC_EDIT_WORKING_DAY_SECTION_TOTAL"], out editTotal))
                {
                    ...
                    {
                        openServicesDate = openServicesDate + editWorkingDay["DROPDOWN_APP_CLINIC_EDIT_WORKING_DAY_SECTION_DAY_TEXT_" + i] + " " + editWorkingDay["DROPDOWN_APP_CLINIC_EDIT_WORKING_DAY_SECTION_START_TIME_TEXT_" + i] + " - " + editWorkingDay["DROPDOWN_APP_CLINIC_EDIT_WORKING_DAY_SECTION_END_TIME_TEXT_" + i] + " น. , ";
                    }
            ...
            var relateLicenseNo = requestLicenseOriginal.ApplicationRequestNumber;
            ...
            var permitEndOld =  requestLicenseOriginal.Data.TryGetData("ELICENSE_INFORMATION").ThenGetStringData("PermitEndYear");
